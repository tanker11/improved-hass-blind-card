        ...
        .sc-blinds { padding: 16px; }
          ...
          .sc-blind-middle { display: flex; width: 210px; margin: auto; }
            ...
            .sc-blind-selector { flex: 1; }
              ...
              .sc-blind-selector-slide { position: absolute; top: 19px; left: 6px; width: 92.5%; height: 0; }
                .sc-blind-selector-slide { background-image: url(data:@file/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAGCAIAAACNcmNmAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAUSURBVBhXY/j//z8TAwMDKmZgAABCTgMI+9FQVwAAAABJRU5ErkJggg==); }
